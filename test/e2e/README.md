...
> The test suite is based on [VK 1.0](https://github.com/ansjin/virtual-kubelet/releases/tag/v1.0.0). If your VK implementation is based on legacy VK library (< v1.0.0), you will have to upgrade it to VK 1.0 using [virtual-kubelet/node-cli](https://github.com/ansjin/node-cli).
...
PASS
ok      github.com/ansjin/virtual-kubelet/internal/test/e2e    12.298s
?       github.com/ansjin/virtual-kubelet/internal/test/e2e/framework  [no test files]
...
```
