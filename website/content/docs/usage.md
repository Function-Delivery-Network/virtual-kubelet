...
> At this time, automation of this deployment is supported only for the [`mock`](https://github.com/ansjin/virtual-kubelet/tree/master/cmd/virtual-kubelet/internal/provider/mock) provider.
...
You can use the Virtual Kubelet [Helm chart](https://github.com/ansjin/virtual-kubelet/tree/master/charts) to deploy Virtual Kubelet on Kubernetes.
...
This would install the [Azure Container Instances Virtual Kubelet](https://github.com/ansjin/virtual-kubelet/tree/master/providers/azure) in the `virtual-kubelet` namespace.
